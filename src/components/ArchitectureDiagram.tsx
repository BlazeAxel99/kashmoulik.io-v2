        ...
        <svg viewBox="0 0 520 200" fill="none" xmlns="http://www.w3.org/2000/svg" className="arch-svg">
          ...
          <defs>
            ...
            <filter id="shadowFilter" x="-10%" y="-10%" width="120%" height="120%">
              <feDropShadow dx="0" dy="6" stdDeviation="6" floodColor="var(--accent-cyan)" floodOpacity="0.15" />
            </filter>
          ...
          <g transform="translate(140, 45)">
            ...
            <circle cx="60" cy="38" r="18" fill="var(--accent-cyan)" fillOpacity="0.08" />
          ...
          <g transform="translate(300, 45)">
            ...
            <circle cx="60" cy="38" r="18" fill="var(--accent-blue)" fillOpacity="0.08" />
      ...
      <svg viewBox="0 0 520 200" fill="none" xmlns="http://www.w3.org/2000/svg" className="arch-svg">
        <defs>
          ...
          <filter id="tealGlow" x="-10%" y="-10%" width="120%" height="120%">
            <feDropShadow dx="0" dy="6" stdDeviation="6" floodColor="var(--accent-teal)" floodOpacity="0.12" />
          </filter>
        </defs>
        ...
        <g transform="translate(140, 45)">
          ...
          <circle cx="60" cy="38" r="18" fill="var(--accent-teal)" fillOpacity="0.08" />
